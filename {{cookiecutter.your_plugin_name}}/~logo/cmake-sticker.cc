...
int main() {
    ...
    std::vector<std::string> info = { 
        "\033[90mProject:\033[0m       {{cookiecutter.your_plugin_name}}",
        ...
        "\033[90mWebsite:\033[0m       https://github.com/9and3/{{cookiecutter.your_plugin_name}}",
        "\033[90mLicense:\033[0m       MIT",
        "\033[90mC++ Standard:\033[0m  17",
        "\033[90mCMake Min Ver:\033[0m 3.15",
        "\033[90mSDK:\033[0m           Rhino 8/7",
        "\033[90mTemplate:\033[0m      cookiecutter gh:9and3/{{cookiecutter.your_plugin_name}}",
